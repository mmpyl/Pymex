...
import { proveedorSchema } from '../schemas/catalogoSchemas';

const emptyForm = { nombre: '', documento: '', email: '', telefono: '', direccion: '', contacto: '' };

const ProveedoresPage = () => {
  const { items: proveedores, create, update, remove } = useProveedores();
  ...
  const handleSubmit = async (e) => {
    ...
    const validation = proveedorSchema.safeParse(form);
