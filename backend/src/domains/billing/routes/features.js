...
router.put('/empresas/:empresaId/features/:featureId', ensureTenantAccess({ paramKey: 'empresaId' }), checkPermission('usuarios_gestionar'), (req, res, next) =>
...
router.get('/empresas/:empresaId/effective', ensureTenantAccess({ paramKey: 'empresaId' }), checkPermission('usuarios_gestionar'), (req, res, next) =>
